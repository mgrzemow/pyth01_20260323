import cwiczenia.subdir1.subdir2.konfiguracja


def wczytaj_towary(nazwa_pliku: str = cwiczenia.subdir1.subdir2.konfiguracja.PLIK_TOWARY) -> dict[str, tuple[float, str, float]]:
    """
